...
struct Picture
{
    ...
    menuPic[2] = {10, 100, txLoadImage("Pic/Растительность/brov.bmp"), 150, 150, 500, 500, false, "растительность"};
    menuPic[3] = {10, 300, txLoadImage("Pic/Растительность/usi.bmp"), 150, 150, 500, 500, false, "растительность"};
