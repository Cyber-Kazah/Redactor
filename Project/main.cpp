    ...
    string runFiledialog(bool isSave)
    {
            ...
            string Filename = "";
            OPENFILENAME ofn;
            TCHAR szFile[260] = {0};       //размеры хранилища
    ...
    btn[2] = {460, 30,  "шляпы", "шляпы"};
    btn[3] = {660, 30,  "оптика", "оптика"};
    btn[4] = {860, 30,  "аксессуары", "аксессуары"};
    btn[5] = {1060, 30,  "друзья", "друзья"};
    btn[6] = {760, 650,  "Снимок экрана", ""};
    ...
    while(!btn[btn_exit].click())
    {
        ...
        else if(page == page_help)
        {
            ...
            txDrawText(0, 0, 1200, 700,
                         "Программа Гардероб \n"
                         "К твоему выбору предоставляется несколько удивительних звёзд, которых ты можешь одевать в разнообразные одевания\n"
                         "Управление происходит двумя способами: А. Стрелками, Б. Мышкой. \n"
                         "Аксесуары можно как увеличит, так и уменьшить на кнопки + и - соответственно\n"
                         "Сохранение и загрузка твоих художеств происходят по отдельных кнопках в нижнем левом углу \n"
                         "Вы можете сделать снимок ваших художеств, поместив их в окно и нажав одноимённую кнопку. \n"
                         "Выход на ESC. \n");
